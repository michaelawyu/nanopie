...
INVALID_HEADER_RESPONSE = HTTPResponse(
    ...
    headers={},
    mime_type='text/html',
    data=('<h2>401 Unauthorized: must include an API key in the '
          'request header.</h2>')
)
INVALID_QUERY_ARGS_RESPONSE = HTTPResponse(
    ...
    headers={},
    mime_type='text/html',
    data=('<h2>401 Unauthorized: must include an API key '
...
INVALID_TOKEN_RESPONSE = HTTPResponse(
    ...
    headers={},
    mime_type='text/html',
    data=('<h2>403 Forbidden: the provided API key is not valid '
          '</h2>')
)
